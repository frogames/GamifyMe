...
namespace GamifyMe.Api.Migrations
{
    ...
    [Migration("20251230100544_AddActivityDomainToStrategy")]
    partial class AddActivityDomainToStrategy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GamifyMe.Shared.Models.Badge", b =>
                {
                    ...
                    b.Property<Guid?>("PrerequisiteBadgeId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GamifyMe.Shared.Models.BlogPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GamifyMe.Shared.Models.ContentKit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("HasBadges")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasGroups")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasObjectives")
                        .HasColumnType("boolean");

                    b.Property<bool>("HasStoreItems")
                        .HasColumnType("boolean");
                    ...
                    b.Property<Guid>("TemplateEstablishmentId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TemplateEstablishmentId");

                    b.ToTable("ContentKits");
                });
            ...
            modelBuilder.Entity("GamifyMe.Shared.Models.GamificationStrategy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int>("ActivityDomain")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("EngagementEngine")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("GamificationStrategies");
                });
            ...
            modelBuilder.Entity("GamifyMe.Shared.Models.KitRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GamifyMe.Shared.Models.Objective", b =>
                {
                    ...
                    b.Property<int>("AllowedValidationMethods")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("RequiredPeerValidations")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GamifyMe.Shared.Models.PeerObjectiveSignature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PeerObjectiveSignatures");
                });
            ...
            modelBuilder.Entity("GamifyMe.Shared.Models.User", b =>
                {
                    ...
                    b.Property<bool>("PrefChallengesEnabled")
                        .HasColumnType("boolean");

                    b.Property<bool>("PrefGroupsEnabled")
                        .HasColumnType("boolean");

                    b.Property<bool>("PrefShopEnabled")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("GamifyMe.Shared.Models.ContentKit", b =>
                {
                    b.HasOne("GamifyMe.Shared.Models.Establishment", "TemplateEstablishment")
                        .WithMany()
                        .HasForeignKey("TemplateEstablishmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TemplateEstablishment");
                });
            ...
            modelBuilder.Entity("GamifyMe.Shared.Models.GamificationStrategy", b =>
                {
                    b.HasOne("GamifyMe.Shared.Models.Establishment", "Establishment")
                        .WithOne("Strategy")
                        .HasForeignKey("GamifyMe.Shared.Models.GamificationStrategy", "EstablishmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GamifyMe.Shared.Models.KitRating", b =>
                {
                    b.HasOne("GamifyMe.Shared.Models.ContentKit", "Kit")
                        .WithMany("Ratings")
                        .HasForeignKey("KitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GamifyMe.Shared.Models.PeerObjectiveSignature", b =>
                {
                    ...
                    b.HasOne("GamifyMe.Shared.Models.User", "PerformerUser")
                        .WithMany()
                        .HasForeignKey("PerformerUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GamifyMe.Shared.Models.User", "WitnessUser")
                        .WithMany()
